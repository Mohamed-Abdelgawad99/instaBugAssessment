...
public class ProductSearchSteps {
    ...
    public void searchResultsPageLoads() {
        ...
        Assert.assertTrue(searchResultsPage.loadingSearchResultsPage(scenario));
    ...
    public void searchResultPageHasResults(int numberOfSearchResults) {
        ...
        int actualSearchResults = searchResultsPage.validateNumberOfSearchResults(scenario);
        ...
        scenario.log("Search Results number validated successfully!");
